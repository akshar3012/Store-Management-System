...
<head>
  ...
  <style>
    body {
      ...
      background: linear-gradient(to right, #edf0f6, #f8fbff);
    ...
    <div class="row g-4">
      <div class="col-md-6 col-lg-4">
        <div class="dashboard-card text-center">
          ...
          <h4>Departments</h4>
          <p>Edit or update existing departments.</p>
          <a href="deparment.php" class="btn btn-dark w-100">Manage</a>
        </div>
      </div>
      <div class="col-md-6 col-lg-4">
        <div class="dashboard-card text-center">
          ...
          <p>View, edit or delete categories.</p>
          <a href="Pro_catagories.php" class="btn btn-dark w-100">Manage</a>
        </div>
      </div>
      <div class="col-md-6 col-lg-4">
        <div class="dashboard-card text-center">
          ...
          <h4>Products</h4>
          <p>Update product price and stock.</p>
          <a href="product.php" class="btn btn-dark w-100">Manage</a>
        </div>
      </div>
      <div class="col-md-6 col-lg-4">
        <div class="dashboard-card text-center">
          ...
          <p>View invoice summaries and analytics.</p>
          <a href="billing.php" class="btn btn-dark w-100">View</a>
        </div>
      </div>
    </div>
  </div>
